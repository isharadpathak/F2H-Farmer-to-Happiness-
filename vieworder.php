...
<tr>
  <th>UserName</th><th> Customer Name</th>  <th>Mobile</th>  <th>Address</th>  <th>Card id</th>
  <th>Ocation</th>  <th>Category</th> <th>Quantity</th><th>Amount</th>
</tr>
<?php
include("conn.php");
...
while($r=mysqli_fetch_assoc($x))
{
  ?>
<tr>
  <td><?php echo $r['uname']?></td><td><?php echo $r['name']?></td><td><?php echo $r['mob']?></td>
  <td>
  <?php echo $r['address']?>
</td><td><?php echo $r['cid']?></td><td><?php echo $r['ocation']?></td><td><?php echo $r['category']?></td>
<td><?php echo $r['qty']?></td><td><?php echo $r['total']?>  &#x20B9;</td>
